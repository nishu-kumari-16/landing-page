export const testimonialsMetaData = [
  {
    ...
    name: "Paul Star",
    review:
      "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Culpa sit rerum incidunt, a consequuntur recusandae ab saepe illo est quia obcaecati neque quibusdam eius accusamus error officiis atque voluptates magnam!Lorem ipsum dolor sit amet consectetur adipisicing elit. Quipraesentium neque dicta quidem nostrum, adipisci expedita dolorumat pariatur corrupti velit inventore numquam nam officia, remsimilique? Fuga nesciunt aperiam cumque veritatis nisi repudiandaemagnam sunt illum, ullam minus pariatur facere, et nulla optiosapiente eos voluptatem soluta itaque! Quo.",
  },
  {
    rating: 3,
    profile:
